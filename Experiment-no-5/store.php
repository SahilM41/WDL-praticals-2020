	...
	-webkit-background-clip: text;-webkit-text-fill-color: transparent;"><strong>Groceries & Staples.</strong></h2>
                    <div class="row  pl-0 pr-0 mr-0 ml-0 products_card pt-2 Gro_products">
                        ...
                        <div class="card mb-3" style="width: 14rem;">
                                    <img class="card-img-top" height="190" src="./images/Biscuit.jpg" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title">Parle</h5>
                                            <div class="card-text">
                                            <i class="fa fa-inr" ></i><strong>20</strong>
                                                <div class="d-block flex-column">
                                                <h6>Category: biscuit</h6>
                                                <p class="text-muted"> SubCategory: biscuit</p>
                                                <p class="mt-0 pt-0">Size: 50 </p>
                                                </div>
                                            </div>
                                            <hr>
                                            <div>
